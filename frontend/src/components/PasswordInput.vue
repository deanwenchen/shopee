...
<template>
  <div class="bg-[#f8f8f8] content-stretch flex h-[52px] items-center px-[20px] py-[16px] rounded-[60px] w-[335px]">
    <input
    ...
    <button
      ...
      class="ml-2 cursor-pointer border-none bg-transparent p-0"
    >
      <img
        :src="showPassword
